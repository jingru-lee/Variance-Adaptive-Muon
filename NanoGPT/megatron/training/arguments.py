...
def _add_regularization_args(parser):
    ...
    group.add_argument('--adamuon', type=bool, default=True, required=False,
                        help="Whether to use AdaMuon")
    ...
    group.add_argument('--muon_nesterov', action='store_false',
                        default=True, help='If set, disable Nesterov momentum for muon')
    return parser
