...
def parse_args(base_parser, args, namespace):
    ...
    # Optimization - only four optimizers retained
    parser.add_argument(
        "--opt",
        default="adamw",
        choices=[
    ...
    parser.add_argument("--muon_nrs_alpha", default=1000.0, type=float)
    
    # Weight averaging parameters (retained for experiments)
    parser.add_argument(
